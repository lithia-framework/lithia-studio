          ...
          <motion.div
            ...
            <motion.div
              ...
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-xl font-bold text-white">Server Disconnected</h2>
              </div>
              <p className="max-w-md text-sm text-white/70">
                The connection to the Lithia development server has been lost. Please wait while we attempt to
                reconnect...
              </p>
            </motion.div>
