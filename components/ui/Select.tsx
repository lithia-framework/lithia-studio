...
const Select = forwardRef<HTMLDivElement, SelectProps>(
  (
    ...
    const variantClasses = {
      default:
        'border-white/10 bg-background-secondary text-white focus:border-primary focus:ring-primary/50',
      filled:
        'border-transparent bg-background-secondary text-white focus:bg-background-secondary focus:ring-primary/50',
      outlined:
        'border-white/10 bg-transparent text-white focus:border-primary focus:ring-primary/50',
    };
